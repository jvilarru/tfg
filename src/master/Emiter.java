...
public class Emiter{
    ...
    /**This function send a message ordering to do some action with the "virtual"
     * keyboard or mouse.
     * 
     * <p>
     ...
     * PRESSED
     * RELEASED
     * The message it is always a representation of the key pressed/released
     * MOUSE_TYPE: it is a message from the mouse, their subtypes are:
     * BUTTON_PRESSED
     * BUTTON_RELEASED
     * The message is the number of the button that has been pressed/released
     * MOVE
     * The message is the x & y position in the range 0-1 in double precision: Example 0.23322,0.85686
     * WHEEL
     * The message is the movement of the mouse wheel
     * TABLET_TYPE: it is a message form the graphical tablet, their subtypes are
     * the same as in the MOUSE
     * 
